...
require_once('class.phpmailer.php');
 ...
 class mailing{
    ...
    public $smtp_host = 'smtp.hostinger.com.ar';
    public $smtp_email = 'info@amavia.com.ar'; //se usa para enviarselo al admin en el caso que sea necesario
    public $smtp_password = 'Amavia210213';
    public $smtp_alias = 'info@amavia.com.ar';
...
function EnviarMailArchivoProcesado($nombre,$apellido,$email,$archivo,$errores)
{
  ...
  $template= str_replace('{{mensaje}}',$mensaje , $template);
    ...
    try {
        ...
        $mail->From = $this->smtp_alias;
        $mail->FromName = $this->smtp_name;
        $mail->Subject = 'Sus calculos  de Valor Criterio han finalizado';
